        ...
        <form action="ManterCliente.do" method="post">
            ...
            <div class="row">
                <div class="form-group col-md-6">
                    ...
                    <input type="tel" class="form-control" name="area" id="area" maxlength="15">
                </div>

                <div class="form-group col-md-6">
                    <label for="email">Populacao</label>
                    <input type="email" class="form-control" name="populacao" id="populacao" required maxlength="60">
                </div>
            </div>
            <hr />
